...
def create_image_custom_path(instance, filename):
    _, extensions = os.path.splitext(filename)

    filename = f"{slugify(instance.title)}-{uuid.uuid4()}.{extensions}"
...
class Movie(models.Model):
    ...
    image = models.ImageField(null=True, upload_to=create_image_custom_path)
